# Examen Práctico Final (C4) — Temática: PANADERÍA
...
| `internal/models/producto.go` | BLOQUEADO | Modelo de ejemplo (Entidad A). |
| `internal/models/estados.go` | BLOQUEADO | Constantes de estado del pedido. |
| `internal/models/cliente.go` | **TAREA CP1** | Complete los campos. |
| `internal/models/pedido.go` | **TAREA CP1** | Complete los campos. |
...
| `internal/storage/producto_gorm.go` | BLOQUEADO | Implementación GORM de ejemplo. |
| `internal/storage/cliente_gorm.go` | **TAREA CP1** | Impleméntela. |
| `internal/storage/pedido_gorm.go` | **TAREA CP2** | Impleméntela. |
| `internal/services/errores.go` | BLOQUEADO | Errores de dominio. |
| `internal/services/producto_service.go` | BLOQUEADO | Service de ejemplo. |
| `internal/services/cliente_service.go` | **TAREA CP1** | Impleméntelo. |
| `internal/services/pedido_service.go` | **TAREA CP2** | Las 5 reglas de negocio viven aquí. |
...
| `internal/handlers/producto_handler.go` | BLOQUEADO | Handler de ejemplo (mapeo de errores). |
| `internal/handlers/cliente_handler.go` | **TAREA CP1** | Impleméntelo. |
| `internal/handlers/pedido_handler.go` | **TAREA CP3** | Impleméntelo. |
...
El seeder carga 4 productos (una inactiva) la primera vez.
